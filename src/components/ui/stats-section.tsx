    ...
    >
      {data.map((item, index) => (
        ...
        >
          ...
          {/* Download Action */}
          <motion.button
            className="mt-6 flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors duration-200 group"
            whileHover={{ x: 5 }}
          >
            <Download className="w-4 h-4" />
            <span className="text-sm">Download the data</span>
            <motion.div
              className="w-4 h-4 rounded-full border border-gray-300 flex items-center justify-center group-hover:border-gray-500"
